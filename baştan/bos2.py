...
def display_website_content(content):
    with open('D:\\2022-2023 2.dönem\\487\\487FinalProject\\baştan\\temp.html', 'r', encoding='utf-8') as file:
        content = file.read()
...
button = ttk.Button(
    frame, text="Go", command=lambda: update_website_content(url_entry.get()))
